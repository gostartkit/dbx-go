...
- 不要新增不受限制的 SQL 入口，也不要在未经讨论的情况下重新引入类似 `run sql` 的工作流。
- 不要引入大型 CLI 或交互框架。
...
- 当命令行为变化时，内嵌 help 文案、命令示例和 Markdown 文档必须同步更新。
- 当用户可见的命令面或工作流变化时，`README.md`、`README.zh-CN.md`、`CONTRIBUTING.md`、`CONTRIBUTING.zh-CN.md` 和 `AGENTS.md` 需要一起更新。
